...
import { SkySelectionBoxGridAlignItemsType } from 'projects/forms/src/public-api';
...
export class SelectionBoxVisualComponent implements OnInit {
  ...
  public selectionBoxes: any[] = [
    ...
    },
    {
      ...
      description:
        'Donec tincidunt lectus et ligula dapibus, a iaculis nibh sagittis',
    },
    {
      name: 'Praesent sed fermentum elit',
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus elementum placerat tortor, sit amet convallis ligula consequat sit amet. Etiam quis pretium nunc.',
    },
    {
  ...
  public onToggleAbleFirstCheckboxClick(): void {
    if (this.myForm.get('checkboxes').get('0').disabled) {
      this.myForm.get('checkboxes').get('0').enable();
    } else {
      this.myForm.get('checkboxes').get('0').disable();
    }
  }
