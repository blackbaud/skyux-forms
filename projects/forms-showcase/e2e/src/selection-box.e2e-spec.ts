...
describe('Selection box', () => {
  ...
  async function clickRadio(): Promise<void> {
    await element(
      by.css('#screenshot-selection-box-radio .sky-selection-box')
    ).click();
  ...
  async function clickCheckbox(): Promise<void> {
    await element(
      by.css('#screenshot-selection-box-checkbox .sky-selection-box')
    ).click();
  ...
  function runTests(): void {
    it('should match previous screenshot with a radio button', async (done) => {
      ...
      expect('#screenshot-selection-box-radio').toMatchBaselineScreenshot(
        done,
        {
    ...
    it('should match previous screenshot with a checkbox', async (done) => {
      ...
      expect('#screenshot-selection-box-checkbox').toMatchBaselineScreenshot(
        done,
        {
    ...
    it('should match previous screenshot with a checkbox when in hover state', async (done) => {
      ...
      browser
        ...
        .then(() => {
          expect(
            '#screenshot-selection-box-checkbox'
    ...
    it('should match previous screenshot with a checkbox when in focus state', async (done) => {
      ...
      element(by.css('#screenshot-selection-box-checkbox .sky-selection-box'))
        .click()
        .then(() => {
          element(
            by.css('#screenshot-selection-box-checkbox .sky-selection-box')
    ...
    it('should match previous screenshot when disabled', async (done) => {
      ...
      await clickCheckbox();
      expect('#screenshot-selection-box-disabled').toMatchBaselineScreenshot(
        done,
        {
    ...
    it('should match previous screenshot with no icon', async (done) => {
      ...
      expect('#screenshot-selection-box-no-icon').toMatchBaselineScreenshot(
        done,
        {
    ...
    it('should match previous screenshot inside a sky-selection-box-grid', async (done) => {
      ...
      expect('#screenshot-selection-box-grid').toMatchBaselineScreenshot(done, {
